      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {/* News Item 1 */}
            <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-[#f2f2f2]">
          ...
          <div className="text-center">
            <Link
              href="/news"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#191919] border border-[#f2f2f2] rounded-md hover:bg-[#f2f2f2] transition-colors"
            >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {/* Deal 1 */}
            <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-[#f2f2f2]">
              <div className="relative">
                <Image
                  src="/placeholder.svg?height=200&width=400"
